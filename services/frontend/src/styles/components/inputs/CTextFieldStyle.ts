...
export function CTextFieldStyle(theme: Theme, Props: CTextFieldProps) {
	return {
		//Label
		"& .MuiInputLabel-root": {
		...
		"& .MuiOutlinedInput-root": {
			...
			fontSize: Props.fontSize == undefined ? appTexts.text.sizes.md : Props.fontSize,
			fontFamily: Props.fontFamily == undefined ? appTexts.text.mainFamily : Props.fontFamily,
